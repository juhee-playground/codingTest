# 아침코테 #코드업 #파이썬 #기초100제 #기초비트시프트연산

# 타이틀: 6046 [기초-비트시프트연산] 정수 1개 입력받아 2배 곱해 출력하기
...
# 타이틀: 6046 [기초-비트시프트연산] 정수 1개 입력받아 2배 곱해 출력하기
# 문제: 정수 2개(a, b)를 입력받아 a를 2b배 곱한 값으로 출력해보자. 0 <= a <= 10, 0 <= b <= 10

'''

참고
예를 들어 1 3 이 입력되면 1을 2의 3승(8)배 하여 출력한다.
