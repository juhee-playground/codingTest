# 아침코테 #코드업 #파이썬 #기초100제 #종합 #소리파일저장용량계산하기

# 타이틀: 6084 : [기초-종합] 소리 파일 저장용량 계산하기
# 문제: 1초 동안 마이크로 소리강약을 체크하는 횟수를 h (헤르쯔, Hz 는 1초에 몇 번? 체크하는가를 의미한다.)
...
# h = 헤르츠, b = bit count , c = channel count, s = time
h, b, c, s = input().split()
